...
@section('content')
    ...
    <div class="bg-white p-4 rounded">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
            ...
            <x-dashboard-card title="Today's Check In" count="{{$totalCheckIn}}" /> <!-- Update if necessary -->
            <x-dashboard-card title="Today's Check Out" count="{{$totalCheckOut}}" /> <!-- Update if necessary -->
