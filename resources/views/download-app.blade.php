...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <section class="container mx-auto my-10 px-5 text-center">
        ...
        <img src="https://scontent.fdvo2-2.fna.fbcdn.net/v/t39.30808-6/251812038_403610324789782_3574069820819899217_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=cc71e4&_nc_eui2=AeHLdnur_m8EX3IfXhxJGNA9TVhfm02YQtxNWF-bTZhC3NY8-doMc-6VgEO3Xd805Xcu4YnozWfCtwsEy-CgG9h-&_nc_ohc=sLM6LkuCTscQ7kNvgEV0fQv&_nc_zt=23&_nc_ht=scontent.fdvo2-2.fna&_nc_gid=A1V880UlKgSdkXPrC0kYvGK&oh=00_AYAM0P1TzDXJl0BN-dbUOziL5thwuMuYA6p9qlR0lABBtA&oe=672784FC" alt="Beautiful view of Samahang Nayon hotel" class="rounded-lg shadow-lg mx-auto">
    </section>
    ...
    <main class="container mx-auto my-10 px-5">
        ...
        <!-- Download Section -->
        <section id="download" class="text-center bg-gradient-to-r from-green-500 to-green-600 p-10 text-white rounded-lg shadow-lg">
            ...
            <div class="flex justify-center gap-4">
                ...
                <a href="#" class="bg-white text-gray-800 font-semibold py-3 px-6 rounded-full shadow-lg hover:bg-gray-100 transition duration-300">
