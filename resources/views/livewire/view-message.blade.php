<div class="w-full h-screen shadow rounded overflow-hidden z-0">
    <div class="grid grid-cols-12 h-full">
        ...
        <!-- Chat Area -->
        <div class="col-span-9 relative bg-white flex flex-col h-full">

            <!-- Chat Header -->
            <div class="p-4 bg-cyan-100 border-b border-gray-300 z-0">
            ...
            <!-- Messages Area -->
            <div class="flex-1 overflow-auto p-4" wire:poll.debounce.1000ms style="height: 70vh; max-height: 80vh">
                @if ($selectedGuest)
